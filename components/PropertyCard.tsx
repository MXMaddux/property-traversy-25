...
import { IPropertyLean } from "@/models/Property"; // Import IPropertyLean
import {
  FaBed,
  FaBath,
  FaRulerCombined,
...
interface PropertyCardProps {
  property: IPropertyLean; // Use IPropertyLean instead of Property
}
    ...
    <div className="rounded-xl shadow-md relative">
      ...
      <div className="p-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          ...
          <Link
            href={`/properties/${String(property._id)}`} // Cast _id to string
